...
class MeshCoordinatorClient:
    ...
    async def lookup_customer(
        ...
        *,
        ...
        return await self._invoke(
            ...
            arguments={"customer_id": customer_id, "correlation_id": correlation_id},
            result_key="customer_context",
    ...
    async def notify_customer(
        ...
        *,
        ...
        return await self._invoke(
            ...
            result_key="notification_receipt",
            user_access_token=user_access_token,
        )
    ...
    async def _invoke(
        ...
        *,
        ...
        task = {"schema_version": "1.0.0", "operation": operation, **arguments}
        ...
        if not isinstance(result, dict):
            raise A2AInvocationError(operation, f"Specialist returned no {result_key}")
        return result, [str(actor) for actor in act_chain]

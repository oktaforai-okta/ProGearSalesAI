    ...
    async def execute(self, prompt: str, *, user_access_token: str) -> WorkflowResult:
        ...
        try:
            ...
            events.append(TraceEvent(
                ...
                correlation_id=correlation_id,
                detail=f"Inventory receipt {inventory.receipt_id}; resource-side Agent Authorization passed",
            ...
            return WorkflowResult(
                ok=False,
                content=(
                    "The request was denied by the delegated authorization path. Inventory was not "

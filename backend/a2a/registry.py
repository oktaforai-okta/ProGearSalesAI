    ...
    return {
        ...
        "agents": [
            ...
            },
            {
                ...
                "outbound": ["Okta MCP Bridge", "Inventory MCP · inventory:write"],
            },
            {
                "key": "google_customer",
                ...
                "dual_citizen": True,
                "inbound": ["ProGear Coordinator"],
                "outbound": ["Okta MCP Bridge", "Customer MCP · customer:read, customer:notify"],
            },
        ],
        "resources": [
            {
                ...
                "enforcement": "Okta scope policy + exact AWS actor + idempotency",
            },
            {
                "name": "Customer MCP",
        ...
        "mcp_bridge": {
            "status": status("A2A_MCP_BRIDGE_URL"),
            "role": "Connects each specialist only to its permitted MCP resource",
        },
    }

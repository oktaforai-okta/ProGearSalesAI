        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={busy !== null}
              className="px-3 py-1.5 text-xs rounded-lg border border-orange-300 bg-orange-50 hover:bg-orange-100 text-orange-700 disabled:opacity-50 flex items-center gap-1"
            >
            ...
            <button
              ...
              disabled={busy !== null}
              className="px-3 py-1.5 text-xs rounded-lg border border-gray-300 bg-gray-50 hover:bg-gray-100 text-gray-700 disabled:opacity-50"
            >
              Set false
            </button>
          </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={busy !== null}
              className="px-3 py-1.5 text-xs rounded-lg border border-green-300 bg-green-50 hover:bg-green-100 text-green-700 disabled:opacity-50"
            >
              Set true
            </button>
            <button

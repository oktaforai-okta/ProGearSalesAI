      ...
      <div className="p-4 space-y-4">
        ...
        <div className="overflow-hidden rounded-lg border border-gray-200">
          <table className="w-full text-left text-xs text-gray-700">
            <caption className="bg-gray-50 px-3 py-2 text-left text-sm font-semibold text-gray-800">
            ...
            <tbody className="divide-y divide-gray-200 bg-white">
              ...
              <tr>
                ...
                <td className="px-3 py-2">An active manager can update standard and classified inventory</td>
              </tr>
              <tr>
                <th scope="row" className="px-3 py-2 font-medium text-gray-800">
                  On vacation: False
